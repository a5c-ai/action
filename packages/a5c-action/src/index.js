...
// Import from A5C SDK
const { loadConfig, executeMainAgent } = require('@a5c/sdk');

// Import local modules
const { handleMentionBasedActivation, handleEventBasedActivation, getMentionableContent } = require('./agent-router');
